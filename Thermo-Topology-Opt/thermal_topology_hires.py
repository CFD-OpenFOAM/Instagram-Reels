...
rmin = 6.0     # Mesh-scaled (2x baseline) -> same physical min feature size
...
ani.save('thermal_topology_hires.mp4', writer=writer, dpi=200)

print("Boom! Video saved as thermal_topology_hires.mp4")